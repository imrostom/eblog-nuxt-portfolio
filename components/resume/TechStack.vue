    ...
    <section class="resume-skills-section resume-section">
        ...
        <ul class="list-unstyled">
            <li class="mb-2">
                ...
                <div class="progress resume-progress" role="progressbar" aria-label="Basic example" aria-valuenow="98"
            ...
            <li class="mb-2">
                ...
                <div class="progress resume-progress" role="progressbar" aria-label="Basic example" aria-valuenow="95"
                    aria-valuemin="0" aria-valuemax="100">
            ...
            <li class="mb-2">
                ...
                <div class="progress resume-progress" role="progressbar" aria-label="Basic example" aria-valuenow="92"
                    aria-valuemin="0" aria-valuemax="100">
            ...
            <li class="mb-2">
                ...
                <div class="progress resume-progress" role="progressbar" aria-label="Basic example" aria-valuenow="86"
                    aria-valuemin="0" aria-valuemax="100">
